    ...
    if(cname.value != '' && email.value != '' &&  password.value != '' &&  phone.value != '' && familycount.value != '' && doornumber.value != '' && street.value != '' && landmark.value != '' &&  district.value != '' && state.value != '' && pincode.value != '' && passwordval()==true && emailValidate()==true && phoneValidate()==true ) {
      const customer = {
        'name' : cname.value,
        'email' : email.value,
        'phone' : phone.value,
